package application.ewallet.infrastructure.adapters.output.data.response;

import application.ewallet.infrastructure.adapters.input.data.responses.premblyResponse.Verification;
